...
s3_client.download_file('lungify-assets', 'models stuff/brucechou1983_CheXNet_Keras_0.3.0_weights.h5', 'brucechou1983_CheXNet_Keras_0.3.0_weights.h5')
s3_client.download_file('lungify-assets', 'models stuff/B2best_Double_Unet_new.hdf5', 'B2best_Double_Unet_new.hdf5')
s3_client.download_file('lungify-assets', 'models stuff/chexnet_model_new2.h5', 'chexnet_model_new2.h5')
...
def build_class_mod():
    ...
    class_mod = tf.keras.Model(base_model2.input, new_base_model)
    return class_mod
